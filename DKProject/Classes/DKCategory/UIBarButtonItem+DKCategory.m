...
+ (instancetype)barButtonBackItemWithTarget:(id)target action:(SEL)action string:(NSString *)string imageEdgeInsets:(UIEdgeInsets)imageEdgeInsets contentHorizontalAlignment:(UIControlContentHorizontalAlignment)contentHorizontalAlignment {
    ...
    if (string) {
        ...
        [button setTitleColor:HexColor(COLOR_666666) forState:UIControlStateNormal];
        [button setTitleColor:HexColor(COLOR_DDDDDD) forState:UIControlStateHighlighted];
...
+ (instancetype)itemWithBoldTitle:(nullable NSString *)title
    ...
    return [self itemWithTarget:target
                     ...
                     titleColor:HexColor(COLOR_666666)
               highlightedColor:HexColor(COLOR_DDDDDD)
...
+(instancetype)itemWithTarget:(nullable id)target
    ...
    return [self itemWithTarget:target
                     ...
                     titleColor:HexColor(COLOR_666666)
               highlightedColor:HexColor(COLOR_666666)
                titleEdgeInsets:UIEdgeInsetsZero
                          image:nil
               highlightedImage:nil
                   disableImage:nil
...
+(instancetype)itemWithTarget:(nullable id)target
    ...
    return [self itemWithTarget:target action:action title:title font:[UIFont pfRegularWithSize:16] titleColor:HexColor(COLOR_666666) image:image isRightImage:isRightImage];
}
...
//    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    ...
    [button setTitleColor:HexColor(COLOR_DDDDDD) forState:UIControlStateDisabled];
