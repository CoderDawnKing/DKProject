...
//    self.delegate = self;
    ...
    [self.navigationBar setTitleTextAttributes:@{
                                                 ...
                                                 NSForegroundColorAttributeName:HexColor(COLOR_333333),
                                                 }];
    ...
    self.view.superview.backgroundColor = HexColor(COLOR_WHITE);
    self.navigationBar.barTintColor = HexColor(COLOR_WHITE);
    [self.navigationBar setShadowImage:[UIImage imageWithColor:HexColor(COLOR_LINE) size:CGSizeMake(dk_ScreenWidth, 1)]];
...
- (void)popAnimation {
    ...
    if (!self.backGroundView) {
        ...
        _backGroundView.backgroundColor = HexColor(COLOR_WHITE);
...
- (UIColor *)backgroundColor {
    if (!_backgroundColor) {
        _backgroundColor = HexColor(COLOR_WHITE);
    }
