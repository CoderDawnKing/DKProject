...
@interface QDKeyboardCustomViewController : DKBaseViewController <QMUIKeyboardManagerDelegate>
...
- (void)initSubviews {
    ...
    self.textView.backgroundColor = UIColor.dk_backgroundColorLighten; 
    [self.containerView addSubview:self.textView];
    
    _toolbarView = [[UIView alloc] init];
    self.toolbarView.backgroundColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<DKThemeProtocol> * _Nullable theme) {
...
- (void)showInParentViewController:(UIViewController *)controller {
    ...
    if (IS_LANDSCAPE) {
        [DKUIHelper forceInterfaceOrientationPortrait];
    }
...
- (void)initSubviews {
    ...
    _commentButton = [DKUIHelper generateLightBorderedButton];
    ...
    _writeReviewButton = [DKUIHelper generateLightBorderedButton];
    ...
    [self.faceButton setImage:[UIImageMake(@"icon_emotion") qmui_imageWithTintColor:UIColor.dk_descriptionTextColor] forState:UIControlStateNormal];
    ...
    self.emotionInputManager.emotionView.emotions = [DKUIHelper qmuiEmotions];
