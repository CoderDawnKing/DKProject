...
- (void)initSubviews {
    ...
    self.progressView1.tintColor = UIColor.dk_tintColor;
    ...
    self.progressView2.tintColor = UIColor.dk_tintColor;
    ...
    self.titleLabel2 = [[UILabel alloc] qmui_initWithFont:UIFontMake(11) textColor:UIColor.dk_descriptionTextColor];
    ...
    self.titleLabel3 = [[UILabel alloc] qmui_initWithFont:UIFontMake(11) textColor:UIColor.dk_descriptionTextColor];
