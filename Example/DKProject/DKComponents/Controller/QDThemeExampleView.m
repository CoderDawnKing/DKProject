...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIColor *textColor = UIColor.dk_descriptionTextColor;
        ...
        self.view.qmui_borderColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<DKThemeProtocol> * _Nullable theme) {
            return [theme.themeTintColor colorWithAlphaComponent:.5];
        }];
        self.view.backgroundColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<DKThemeProtocol> * _Nullable theme) {
            return [theme.themeTintColor colorWithAlphaComponent:.5];
        }];
        ...
        self.textField.tintColor = UIColor.dk_tintColor;
        self.textField.defaultTextAttributes = @{NSFontAttributeName: UIFontMake(14),
                                                 NSForegroundColorAttributeName: UIColor.dk_tintColor};
        ...
        self.label.attributedText = ({
            NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:@"example text..." attributes:@{NSFontAttributeName: UIFontMake(16),
                                                                                                                                  NSForegroundColorAttributeName: UIColor.dk_mainTextColor
                                                                                                                                  }];
            [string addAttribute:NSForegroundColorAttributeName value:UIColor.dk_tintColor range:NSMakeRange(0, @"example".length)];
            string.copy;
        });
        self.label.shadowColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<DKThemeProtocol> * _Nullable theme) {
            return [([identifier isEqualToString:DKThemeIdentifierDark] ? UIColorWhite : UIColorBlack) colorWithAlphaComponent:.5];
        }];
        ...
        self.slider.minimumTrackTintColor = UIColor.dk_tintColor;
        self.slider.maximumTrackTintColor = UIColor.dk_separatorColor;
        ...
        self.switchControlOn.onTintColor = UIColor.dk_tintColor;
        ...
        UIImage *image = [UIImage qmui_imageWithThemeProvider:^UIImage * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<DKThemeProtocol> * _Nullable theme) {
        ...
        self.progressView.progressTintColor = UIColor.dk_tintColor;
        self.progressView.trackTintColor = UIColor.dk_separatorColor;
        ...
        self.visualEffectBackendImageView = [[UIImageView alloc] initWithImage:[UIImage qmui_imageWithThemeProvider:^UIImage * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, __kindof NSObject<DKThemeProtocol> * _Nullable theme) {
        ...
        self.visualEffectView.effect = UIVisualEffect.dk_standardBlurEffect;
        ...
        self.navigationBar.barTintColor = UIColor.dk_tintColor;
        ...
        self.tabBar.barTintColor = UIColor.dk_tintColor;
        ...
        self.toolbar.barTintColor = UIColor.dk_tintColor;
        ...
        self.searchBar.barTintColor = UIColor.dk_tintColor;
        self.searchBar.tintColor = UIColor.dk_tintColor;
