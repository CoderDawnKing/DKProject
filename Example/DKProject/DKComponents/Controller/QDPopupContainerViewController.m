...
- (void)initSubviews {
    ...
    self.button1 = [DKUIHelper generateLightBorderedButton];
    ...
    self.button2 = [DKUIHelper generateLightBorderedButton];
    ...
    self.button3 = [DKUIHelper generateLightBorderedButton];
    ...
    self.button4 = [DKUIHelper generateLightBorderedButton];
    ...
    self.button5 = [DKUIHelper generateLightBorderedButton];
    ...
    self.popupByAddSubview.imageView.image = [[UIImageMake(@"icon_emotion") qmui_imageResizedInLimitedSize:CGSizeMake(24, 24) resizingMode:QMUIImageResizingModeScaleToFill] qmui_imageWithTintColor:UIColor.dk_tintColor];
    ...
    self.popupHorizontal.imageView.image = [[UIImageMake(@"icon_emotion") qmui_imageResizedInLimitedSize:CGSizeMake(24, 24) resizingMode:QMUIImageResizingModeScaleToFill] qmui_imageWithTintColor:UIColor.dk_tintColor];
    ...
    self.popupByWindow.itemConfigurationHandler = ^(QMUIPopupMenuView *aMenuView, QMUIPopupMenuButtonItem *aItem, NSInteger section, NSInteger index) {
        ...
        aItem.button.highlightedBackgroundColor = [UIColor.dk_tintColor colorWithAlphaComponent:.2];
    };
