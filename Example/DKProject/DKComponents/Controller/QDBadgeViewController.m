...
- (void)initSubviews {
    ...
    UITabBarItem *item1 = [DKUIHelper tabBarItemWithTitle:@"QMUIKit" image:[UIImageMake(@"icon_tabbar_uikit") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:UIImageMake(@"icon_tabbar_uikit_selected") tag:0];
    
    UITabBarItem *item2 = [DKUIHelper tabBarItemWithTitle:@"Components" image:[UIImageMake(@"icon_tabbar_component") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:UIImageMake(@"icon_tabbar_component_selected") tag:1];
    item2.qmui_badgeString = @"99+";// 支持字符串
    
    UITabBarItem *item3 = [DKUIHelper tabBarItemWithTitle:@"Lab" image:[UIImageMake(@"icon_tabbar_lab") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:UIImageMake(@"icon_tabbar_lab_selected") tag:2];
...
- (void)didSelectCellWithTitle:(NSString *)title {
    if ([title isEqualToString:@"在 UIBarButtonItem 上显示红点"]) {
        ...
        item.qmui_badgeBackgroundColor = [DKCommonUI randomThemeColor];
