...
- (void)initSubviews {
    ...
    self.view1.backgroundColor = [DKCommonUI randomThemeColor];
    [self.view addSubview:self.view1];
    
    self.view2 = [[UIView alloc] init];
    self.view2.backgroundColor = [DKCommonUI randomThemeColor];
    [self.view addSubview:self.view2];
    
    self.view3 = [[UIView alloc] init];
    self.view3.backgroundColor = [DKCommonUI randomThemeColor];
