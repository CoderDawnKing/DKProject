...
- (void)didSelectCellWithTitle:(NSString *)title {
    ...
    if ([title isEqualToString:@"支持自定义 alert 样式"]) {
        ...
        [action2.button setImage:[[UIImageMake(@"icon_emotion") qmui_imageResizedInLimitedSize:CGSizeMake(18, 18) resizingMode:QMUIImageResizingModeScaleToFill] qmui_imageWithTintColor:UIColor.dk_tintColor] forState:UIControlStateNormal];
        ...
        alertController.alertHeaderBackgroundColor = UIColor.dk_tintColor;
    ...
    if ([title isEqualToString:@"支持自定义 actionSheet 样式"]) {
        QMUIAlertAction *action1 = [QMUIAlertAction actionWithTitle:@"取消" style:QMUIAlertActionStyleCancel handler:NULL];
        QMUIAlertAction *action2 = [QMUIAlertAction actionWithTitle:@"删除" style:QMUIAlertActionStyleDefault handler:NULL];
        [action2.button setImage:[[UIImageMake(@"icon_emotion") qmui_imageResizedInLimitedSize:CGSizeMake(22, 22) resizingMode:QMUIImageResizingModeScaleToFill] qmui_imageWithTintColor:UIColor.dk_tintColor] forState:UIControlStateNormal];
        action2.button.imageEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 8);
        ...
        alertController.sheetHeaderBackgroundColor = UIColor.dk_tintColor;
