...
- (void)didInitializeWithStyle:(UITableViewCellStyle)style {
    ...
    [_label sizeToFit];
    _label.textColor = UIColor.dk_descriptionTextColor;
...
- (void)didInitializeWithStyle:(UITableViewCellStyle)style {
    ...
    for (NSDictionary *dict in infos) {
        ...
        titleLabel.textColor = UIColor.dk_descriptionTextColor;
        ...
        contentLabel.textColor = UIColor.dk_mainTextColor;
...
- (void)didInitializeWithStyle:(UITableViewCellStyle)style {
    ...
    _label1.textColor = UIColor.dk_descriptionTextColor;
    [_label1 sizeToFit];
