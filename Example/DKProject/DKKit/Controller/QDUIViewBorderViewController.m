...
- (void)initSubviews {
    ...
    self.targetView.backgroundColor = [UIColor.dk_tintColor colorWithAlphaComponent:.3];
...
- (QMUILabel *)generateTitleLabelWithText:(NSString *)text {
    QMUILabel *label = [[QMUILabel alloc] qmui_initWithFont:UIFontMake(14) textColor:UIColor.dk_mainTextColor];
    label.text = text;
    [label sizeToFit];
...
- (QMUISegmentedControl *)generateSegmentedControlWithItems:(NSArray<NSString *> *)items {
    ...
    segmentedControl.tintColor = UIColor.dk_tintColor;
...
- (QMUIButton *)generateSelectableButtonWithTitle:(NSString *)title {
    ...
    [button setTitleColor:UIColor.dk_descriptionTextColor forState:UIControlStateNormal];
...
- (QMUITextField *)generateNumericTextField {
    ...
    textField.textColor = UIColor.dk_tintColor;
...
- (void)handleSegmentedControlEvent:(QMUISegmentedControl *)segmentedControl {
    if (segmentedControl == self.locationSegmentedControl) {
        ...
        switch (segmentedControl.selectedSegmentIndex) {
            case 0:
                borderColor = [UIColor.dk_tintColor colorWithAlphaComponent:.5];
                break;
            case 1:
                borderColor = UIColor.dk_tintColor;
                break;
            case 2:
