...
- (void)initSubviews {
    ...
    self.contentView.backgroundColor = UIColor.dk_backgroundColorLighten;
    ...
    self.methodNameLabel = [[UILabel alloc] qmui_initWithFont:CodeFontMake(16) textColor:UIColor.dk_codeColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.textColor = UIColor.dk_codeColor;
...
- (CGFloat)generateExampleViewForAverageColor {
    ...
    UILabel *originImageLabel = [[UILabel alloc] qmui_initWithFont:UIFontMake(14) textColor:UIColor.dk_mainTextColor];
...
- (CGFloat)generateExampleViewForImageWithTintColor {
    ...
    UIImage *afterImage = [originImageView.image qmui_imageWithTintColor:[DKCommonUI randomThemeColor]];
...
- (CGFloat)generateExampleViewForImageWithBlendColor {
    ...
    UIImage *afterImage = [originImageView.image qmui_imageWithBlendColor:[DKCommonUI randomThemeColor]];
    UIImageView *afterImageView = [[UIImageView alloc] initWithImage:afterImage];
    afterImageView.contentMode = originImageView.contentMode;
    afterImageView.frame = CGRectSetY(afterImageView.frame, minY);
    [self.scrollView addSubview:afterImageView];
...
- (CGFloat)generateExampleViewForImageWithImageAbove {
    ...
    UIImageView *originImageView = [[UIImageView alloc] initWithImage:[UIImageMake(@"icon_emotion") qmui_imageWithTintColor:UIColor.dk_tintColor]];
    originImageView.contentMode = UIViewContentModeScaleAspectFit;
    originImageView.frame = CGRectSetY(originImageView.frame, minY);
    [self.scrollView addSubview:originImageView];
    minY = CGRectGetMaxY(originImageView.frame) + 16;
...
- (CGFloat)generateExampleViewForImageWithSpacingExtensionInsets {
    ...
    originImageView.layer.borderColor = [DKCommonUI randomThemeColor].CGColor;
    originImageView.frame = CGRectSetY(originImageView.frame, minY);
    [self.scrollView addSubview:originImageView];
    minY = CGRectGetMaxY(originImageView.frame) + 16;
...
- (CGFloat)generateExampleViewForImageWithBorder {
    ...
    UIImage *afterImage = [originImageView.image qmui_imageWithBorderColor:[DKCommonUI randomThemeColor] path:roundedBorderPath];
...
- (CGFloat)generateExampleViewForImageWithBorderColorAndCornerRadiusWithDashedBorder:(BOOL)dashedBorder {
    ...
    if (dashedBorder) {
        ...
        afterImage = [originImageView.image qmui_imageWithBorderColor:[DKCommonUI randomThemeColor] borderWidth:PixelOne cornerRadius:4 dashedLengths:dashedLengths];
    } else {
        afterImage = [originImageView.image qmui_imageWithBorderColor:[DKCommonUI randomThemeColor] borderWidth:PixelOne cornerRadius:4];
    }
...
- (CGFloat)generateExampleViewForImageWithBorderColorAndCornerRadiusAndPosition {
    ...
    UIImage *afterImage = [originImageView.image qmui_imageWithBorderColor:[DKCommonUI randomThemeColor] borderWidth:PixelOne borderPosition:QMUIImageBorderPositionBottom];
...
- (CGFloat)generateExampleViewForImageWithMaskImage {
    ...
    UILabel *maskImageLabel = [[UILabel alloc] qmui_initWithFont:UIFontMake(14) textColor:UIColor.dk_mainTextColor];
    ...
    UILabel *maskImageLabel2 = [[UILabel alloc] qmui_initWithFont:UIFontMake(14) textColor:UIColor.dk_mainTextColor];
...
- (CGFloat)generateExampleViewForImageWithColor {
    ...
    UIImage *originImage = [UIImage qmui_imageWithColor:[DKCommonUI randomThemeColor] size:CGSizeMake(contentWidth / 2, 40) cornerRadius:10];
    UIImageView *originImageView = [[UIImageView alloc] initWithImage:originImage];
    originImageView.frame = CGRectSetY(originImageView.frame, minY);
    [self.scrollView addSubview:originImageView];
    minY = CGRectGetMaxY(originImageView.frame) + 16;
...
- (CGFloat)generateExampleViewForImageWithColorAndCornerRadiusArray {
    ...
    UIImage *originImage = [UIImage qmui_imageWithColor:[DKCommonUI randomThemeColor] size:CGSizeMake(contentWidth / 2, 40) cornerRadiusArray:@[@0, @0, @10, @10]];
    UIImageView *originImageView = [[UIImageView alloc] initWithImage:originImage];
    originImageView.frame = CGRectSetY(originImageView.frame, minY);
    [self.scrollView addSubview:originImageView];
    minY = CGRectGetMaxY(originImageView.frame) + 16;
...
- (CGFloat)generateExampleViewForImageWithStrokeColorAndPath {
    ...
    UIImage *originImage = [UIImage qmui_imageWithStrokeColor:[DKCommonUI randomThemeColor] size:CGSizeMake(contentWidth / 2, 40) path:path addClip:NO];
    UIImageView *originImageView = [[UIImageView alloc] initWithImage:originImage];
    originImageView.frame = CGRectSetY(originImageView.frame, minY);
    [self.scrollView addSubview:originImageView];
    minY = CGRectGetMaxY(originImageView.frame) + 16;
...
- (CGFloat)generateExampleViewForImageWithStrokeColorAndCornerRadius {
    ...
    UIImage *originImage = [UIImage qmui_imageWithStrokeColor:[DKCommonUI randomThemeColor] size:CGSizeMake(contentWidth / 2, 40) lineWidth:1 cornerRadius:10];
    UIImageView *originImageView = [[UIImageView alloc] initWithImage:originImage];
    originImageView.frame = CGRectSetY(originImageView.frame, minY);
    [self.scrollView addSubview:originImageView];
    minY = CGRectGetMaxY(originImageView.frame) + 16;
...
- (CGFloat)generateExampleViewForImageWithStrokeColorAndBorderPosition {
    ...
    UIImage *originImage = [UIImage qmui_imageWithStrokeColor:[DKCommonUI randomThemeColor] size:CGSizeMake(contentWidth / 2, 40) lineWidth:1 borderPosition:QMUIImageBorderPositionLeft|QMUIImageBorderPositionRight|QMUIImageBorderPositionBottom];
    UIImageView *originImageView = [[UIImageView alloc] initWithImage:originImage];
    originImageView.frame = CGRectSetY(originImageView.frame, minY);
    [self.scrollView addSubview:originImageView];
    minY = CGRectGetMaxY(originImageView.frame) + 16;
...
- (CGFloat)generateExampleViewForImageWithShape {
    ...
    UILabel *titleLabel = [[UILabel alloc] qmui_initWithFont:UIFontMake(14) textColor:UIColor.dk_mainTextColor];
    ...
    UIColor *tintColor = UIColor.dk_tintColor;
...
- (CGFloat)generateExampleLabelAndImageViewWithImage:(UIImage *)image shapeName:(NSString *)shapeName minY:(CGFloat)minY {
    UILabel *exampleLabel = [[UILabel alloc] qmui_initWithFont:UIFontMake(12) textColor:UIColor.dk_mainTextColor];
...
- (CGFloat)generateExampleViewForImageWithAttributedString {
    ...
    NSDictionary *attributes = @{NSFontAttributeName: UIFontMake(16), NSForegroundColorAttributeName: [DKCommonUI randomThemeColor]};
...
- (CGFloat)generateExampleViewForImageWithView {
    ...
    originImageView.contentMode = UIViewContentModeScaleAspectFit;
    originImageView.layer.borderWidth = PixelOne;
    originImageView.layer.borderColor = UIColor.dk_separatorColor.CGColor;
    [originImageView qmui_sizeToFitKeepingImageAspectRatioInSize:CGSizeMake(contentWidth, CGFLOAT_MAX)];
    originImageView.frame = CGRectSetY(originImageView.frame, minY);
    [self.scrollView addSubview:originImageView];
    minY = CGRectGetMaxY(originImageView.frame) + 16;
