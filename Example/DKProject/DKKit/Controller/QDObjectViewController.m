...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [attributedString addAttribute:NSForegroundColorAttributeName value:UIColor.dk_mainTextColor range:NSMakeRange(0, className.length)];
    [attributedString addAttribute:NSForegroundColorAttributeName value:UIColor.dk_descriptionTextColor range:NSMakeRange(className.length, totalName.length - className.length)];
    [attributedString addAttribute:NSForegroundColorAttributeName value:UIColor.dk_tintColor range:matchingRange];
