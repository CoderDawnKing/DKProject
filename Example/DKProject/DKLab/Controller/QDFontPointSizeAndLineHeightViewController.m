...
- (void)initSubviews {
    [super initSubviews];
    self.fontPointSizeLabel = [[UILabel alloc] qmui_initWithFont:UIFontMake(18) textColor:UIColor.dk_mainTextColor];
    ...
    self.fontPointSizeSlider.tintColor = UIColor.dk_tintColor;
    ...
    self.exampleLabel.backgroundColor = UIColor.dk_tintColor;
