...
- (void)didInitialize {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        UIImage *blendedAboutLogoImage = [aboutLogoImage qmui_imageWithBlendColor:UIColor.dk_tintColor];
...
- (void)initSubviews {
    ...
    [self.versionButton setTitleColor:UIColor.dk_mainTextColor forState:UIControlStateNormal];
    ...
    self.copyrightLabel.attributedText = [[NSAttributedString alloc] initWithString:@"© 2020 QMUI Team All Rights Reserved." attributes:@{NSFontAttributeName: UIFontMake(12), NSForegroundColorAttributeName: UIColor.dk_descriptionTextColor, NSParagraphStyleAttributeName: [NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:16 lineBreakMode:NSLineBreakByWordWrapping textAlignment:NSTextAlignmentCenter]}];
...
- (NSString *)userDefaultsKeyForAboutLogoImage {
    return [NSString stringWithFormat:@"about_logo_%@@%.0fx.png", DKThemeManager.currentTheme.themeName, ScreenScale];
}
